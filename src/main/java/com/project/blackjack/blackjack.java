...
public class blackjack extends Application {// переделать для запуска из проги
    ...
    Image imageback = new Image(String.valueOf(blackjack.class.getClassLoader().getResource("table.png")));
